            ...
            <div className='w-[80%] flex justify-center'>
                <div className=' w-full flex flex-col justify-center gap-8 text-white '>
                   ...
                   <div className=' w-full flex flex-col  text-center  '>
                    <span className=' text-[26px] md:text-[50px] font-gilroy-bold gap-4 tracking-wider'>why choose us?</span>
                   ...
                   <div className=' w-full flex flex-col  xl:gap-0 xl:flex-row justify-between items-center  '>
                        ...
                        <div className=' w-[303px] h-[199px] text-center flex flex-col items-center  '>
