      ...
      setLoading(true);
        const getTerms = async ()=>{
          try {
            ...
            // for development.....
            // const res = await fetch(`http://${import.meta.env.VITE_API_URL}/api/v1/terms-and-conditions`)
  ...
  return (
    ...
    <div className=' w-full flex flex-col'>
        <div className=' bg-gradient-to-tr from-[#363434] to-gray-400 w-full flex justify-center'>
            <span className=' text-white py-5 w-[90%] font-gilroy-bold text-[40px] ' style={{ marginTop: '50px' }}>Terms and Conditions</span>
        </div>
