    ...
    <>
      <div className=" h-full relative bg-rose-500 flex w-full lg:py-0 py-5 justify-center items-center md:overflow-hidden ">
        <div className='flex flex-col h-full lg:ml-36 xl:ml-20 md:translate-x-0 w-[80%] md:w-3/5  gap-5 lg:gap-0 justify-center items-center md:overflow-hidden md:max-[1000px]:w-[50%] '>
          ...
          {/* Note: Added new line height in this section title */}
          <div className='md:text-left text-center text-white md:max-w-[380px] w-full  md:max-[1000px]:text-center leading-9 md:leading-[50px] md:mb-5'>
          ...
          {/* Note: Adjustment div width, padding and line height in paragraph */}
          <div className='md:max-w-[450px] max-h-[181px] text-white text-lg md:text-[22px] md:mt-10 md:pl-10'>
            <p className='leading-8 text-[16px] lg:text-[20px] xl:text-[20px] 2xl:text-[22px] font-gilroy-semi-bold' >
