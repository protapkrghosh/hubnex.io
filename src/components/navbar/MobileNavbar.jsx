...
const MobileNavbar = ({ open }) => {
  ...
  return (
    ...
    <div className=' absolute top-0 -right-full   overflow-y-auto flex justify-center h-screen w-24 z-40 xl:hidden '>
      <div className={`xl:hidden ${!open ? 'translate-x-0 ease-out' : '-translate-x-full overflow-y-auto fixed'} h-full w-full  transition-all text-xl duration-500 ease text-white font-gilroy-regular bg-gradient-to-br  from-gray-600 to-gray-800 flex flex-col items-center`}>
          ...
          <div className=' flex flex-col'>
            ...
            </div>
            {
              ...
              <div className="flex flex-col w-[80%] m-auto  rounded-lg">
                ...
                {/* Bug Fix: Solved negative spacing problem */}
